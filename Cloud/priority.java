    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                NewCloudlet cloudlet1 = new NewCloudlet(i, length, pesNumber, fileSize, outputSize, utilizationModel,
                        utilizationModel, utilizationModel, p1);
            ...
            // p1=in.nextInt();
            //
            // NewCloudlet cloudlet1 = new NewCloudlet(id, length, pesNumber, fileSize,
            // outputSize, utilizationModel, utilizationModel, utilizationModel,p1);
            // cloudlet1.setUserId(brokerId);
            //
            // Log.printLine("Enter Priority for Cloudlet 1 :");
            // p2=in.nextInt();
            // id++;
            // NewCloudlet cloudlet2 = new NewCloudlet(id, length, pesNumber, fileSize,
            // outputSize, utilizationModel, utilizationModel, utilizationModel,p2);
            ...
            // p3=in.nextInt();
            // id++;
            // NewCloudlet cloudlet3 = new NewCloudlet(id, length, pesNumber, fileSize,
            // outputSize, utilizationModel, utilizationModel, utilizationModel,p3);
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS) {
                ...
                Log.printLine(indent + indent + cloudlet.getResourceId() + indent + indent + indent + indent
                        ...
                        indent + indent + dft.format(cloudlet.getFinishTime()) + indent + indent
                        + cloudlet.getCloudlet_priority());
            }
        }
